        ...
        <View style={styles.logoRow}>
          ...
          {(expanded || !isDesktop) && (
            <View style={{ marginLeft: 10, flex: 1 }}>
              ...
              <Text style={[styles.logoSubText, { color: C.textSubtle }]}>Assessment Platform</Text>
            </View>
          )}
        </View>
        {!isDesktop && (
                ...
                >
                  <View style={[styles.navItemLeft, { justifyContent: (!expanded && isDesktop) ? 'center' : 'flex-start' }]}>
                    ...
                    <Feather
                      name={item.icon}
                      size={18}
                      color={itemActive ? '#6366F1' : C.textMuted}
                    />
                    {(expanded || !isDesktop) && (
                      <Text style={[styles.navLabel, { color: itemActive ? '#6366F1' : C.textMuted }]}>
                        {item.label}
                      </Text>
                    )}
                  </View>
                  {(expanded || !isDesktop) && item.badge && (
        ...
        <View style={styles.profileRow}>
          ...
          {(expanded || !isDesktop) && (
            <View style={{ marginLeft: 10, flex: 1 }}>
              ...
              <Text style={[styles.profileRole, { color: C.textSubtle }]} numberOfLines={1}>
                {user?.role || 'student'}
              </Text>
            </View>
          )}
